...
## JSON/XHR Exercise for NSS

### Decription
JavaScript exercise to practice XHR callbacks and JSON.

### Instructions
You work as a developer for a big box store. You are provided with a JSON representation of a small sample of the products you sell and of some of the departments in your stores.
